...
const OfficeExpenseForm = ({ user, onSaved, onCancel }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await set(newExpenseRef, formData);
      ...
      showToast("❌ خطا در ثبت هزینه! لطفاً دوباره تلاش کنید", "error");
      setLoading(false);
    }
  };
    ...
    <div style={containerStyle}>
      ...
      <div style={buttonContainerStyle}>
        ...
        <button 
          ...
          style={{...btnStyle, backgroundColor: "#ea580c"}}
          disabled={loading}
        >
